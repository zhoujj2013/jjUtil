...
def usage():
	...
	print '\tUsage: '+sys.argv[0]+' <cor.mat> <prefix>'
	print '\tcor.mat: sample regarding to histone signal density'
	print '\n'
	sys.exit(2)
...
if __name__ == "__main__":
	...
	if not os.path.exists("./RFmodel"):
		os.makedirs("./RFmodel")
	joblib.dump(rf, './RFmodel/RFmod.pkl')
	
	print "Test real:"
	y_test_arr = []
	for yarr in y_test:
		y_test_arr.append(yarr)
	print y_test_arr
	print "Test predict:"
	y_predict_arr = []
	for parr in rf.predict(X_test):
		y_predict_arr.append(parr)
	print y_predict_arr
