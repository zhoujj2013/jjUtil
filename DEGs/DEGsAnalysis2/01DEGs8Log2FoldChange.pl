...
### DEGs
print STDOUT "perl $Bin/log2foldchangeExprNoBaseLine.pl $group_name1.vs.$group_name2.expr 2,3 h > $group_name1.vs.$group_name2.expr.FC\n";
`perl $Bin/log2foldchangeExprNoBaseLine.pl $group_name1.vs.$group_name2.expr 2,3 h > $group_name1.vs.$group_name2.expr.FC`;
