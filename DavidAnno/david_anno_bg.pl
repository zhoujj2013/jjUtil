...
sub usage {
        ...
        This script design for david gene function annotation base on the selected background.
        Require: SOAP::Lite, HTTP::Cookies
        Author: zhoujj2013\@gmail.com
        Usage: $0 <id_Type> <annotation category> <annotation_result_dir_name [./david]> <bg_f> <gene list1> [<gene list2> .. <gene listN>]
		
        id_Type: AFFYMETRIX_3PRIME_IVT_ID,AFFYMETRIX_EXON_GENE_ID,AFFYMETRIX_SNP_ID,AGILENT_CHIP_ID,AGILENT_ID,AGILENT_OLIGO_ID,ENSEMBL_GENE_ID,ENSEMBL_TRANSCRIPT_ID,ENTREZ_GENE_ID,FLYBASE_GENE_ID,FLYBASE_TRANSCRIPT_ID,GENBANK_ACCESSION,GENOMIC_GI_ACCESSION,GENPEPT_ACCESSION,ILLUMINA_ID,IPI_ID,MGI_ID,PFAM_ID,PIR_ID,PROTEIN_GI_ACCESSION,REFSEQ_GENOMIC,REFSEQ_MRNA,REFSEQ_PROTEIN,REFSEQ_RNA,RGD_ID,SGD_ID,TAIR_ID,UCSC_GENE_ID,UNIGENE,UNIPROT_ACCESSION,UNIPROT_ID,UNIREF100_ID,WORMBASE_GENE_ID,WORMPEP_ID,ZFIN_ID,GENE_SYMBOL
...
sub get_anno{
	...
	open (chartReport, ">", "$prefix/$bname.b.david");
